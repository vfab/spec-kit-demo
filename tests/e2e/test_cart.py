...
class TestCart:
    def _navigate_to_product(self, page, live_server, product):
        """Helper: navigate to a product detail page."""
        page.goto(live_server.url + f"/products/{product.slug}/")
        page.wait_for_load_state("networkidle")

    def test_add_item_to_cart(self, page, live_server, db):
    ...
    def test_remove_item_from_cart(self, page, live_server, db):
